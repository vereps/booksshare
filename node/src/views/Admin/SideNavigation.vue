...
<template>
  <nav class="nav flex-column admin-navigation" v-if="isUserAdmin">
    ...
    <router-link class="nav-link" to="/admin/publishers">Publishers</router-link>
...
<style lang="scss">
.admin-navigation {
  background-color: rgba(216, 216, 216, 0.143);
